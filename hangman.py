...
def hangman(secret_word):
    ...
    * Har round ke baar, user ko uska guess kiya hua partial word
    ...
    level=input("enter the level which level you wnat to play ""\n""a for easy""\n""b for medium""\n""c for hard level""\n""you can choose one of the above choice\n" )
    if level=="b":
    ...
    while (remaining_lives>0):
        ...
        if letter=="hint":
            if c<2:
                print("yuor hint for sectre word is"+get_hint(secret_word,letters_guessed))
                c+=1
        else:
        ...
        if letter in secret_word:
            ...
            print("")
            remaining_lives-=1
            print("your guessing is wrong remaining chances",remaining_lives)
            print("")
    else:
